...
const EditEmail = (props) => (
	...
	>
		{(props) => {
			...
			const { values, newEmail, touched, errors, isSubmitting, handleChange, handleBlur, isValid } = props;
				...
				<div>
					<form action="/api/userdata/editemail" method="POST">
						...
						<button
							...
							disabled={errors.newEmail || isSubmitting || isValid}
						>
							Update Email
						</button>
						<br />
						<br />
						Editing your Email will require reconfirmation.
					</form>
				</div>
			);
		}}
